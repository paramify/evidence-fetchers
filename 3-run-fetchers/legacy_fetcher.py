...
def show_help():
    ...
    print()
    print("Usage:")
    print("  python legacy_fetcher.py --provider <provider> [--profile <profile>] [--region <region>] [--timeout <seconds>]")
    print()
    print("Arguments:")
    ...
    print()
    print("Examples:")
    print("  python legacy_fetcher.py --provider aws --profile gov_readonly --region us-gov-west-1")
    print("  python legacy_fetcher.py --provider knowbe4 --profile my_knowbe4_profile")
    print("  python legacy_fetcher.py --provider aws --timeout 300  # 5 minute timeout")
    print("  python legacy_fetcher.py --provider aws  # Uses AWS_PROFILE and AWS_REGION from .env")
    print("  python legacy_fetcher.py                 # Uses DEFAULT_PROVIDER from .env")
    print()
