...
# slow or transient GitLab response no longer fails the whole fetcher run. This
# fetcher is request-heavy (several calls per merge request), so transient
# timeouts/connection resets against gitlab.com are otherwise common.
