...
| `RIPPLING_PARAMIFY_EVIDENCE_ID` | Yes (for upload) | Paramify evidence record UUID where Rippling artifacts are uploaded by the orchestrator | `04726592-06f5-4ec5-a837-5d91116c14e6` |
